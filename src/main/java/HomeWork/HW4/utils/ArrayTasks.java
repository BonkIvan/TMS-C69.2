...
public class ArrayTasks {
    ...
    public ArrayTasks(Scanner scanner, Random random) {
    ...
    public int[][][] creatAndFillingNewArray() {
        int[][][] arr = new int[3][3][3];
    ...
    public void addNumbToArray(int[][][] arr) {
